...
<script>
	$(function(){
		$('#id_alterbasic_nav_bg, #id_alterbasic_nav_icon_colour, #id_alterbasic_nav_active_icon_colour, #id_alterbasic_banner_colour').colorpicker({format: 'rgba'});
		$('#id_alterbasic_link_colour,#id_alterbasic_background_colour').colorpicker();
		$('#id_alterbasic_toolicon_colour,#id_alterbasic_toolicon_activecolour,#id_alterbasic_font_colour').colorpicker();
		$('#id_alterbasic_item_colour,#id_alterbasic_comment_item_colour,#id_alterbasic_comment_border_colour').colorpicker({format: 'rgba'});
	});
</script>
{{/if}}
<div class="settings-submit-wrapper" >
	<button type="submit" name="alterbasic-settings-submit" class="btn btn-primary">{{$submit}}</button>
</div>
